    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name_ar",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="الاسم العربي"
                    ),
                ),
                (
                    "name_en",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="اسم الصنف"
                    ),
                ),
                (
                    "description",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="اسم الوحدة الأساسية"
                    ),
                ),
                (
                    "abbreviation",
                    models.CharField(max_length=20, verbose_name="التمييز"),
                ),
                (
                    "template",
                    models.CharField(
                        help_text="مثال: الوزن", max_length=50, verbose_name="القالب"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "voucher_number",
                    models.CharField(
                        blank=True, max_length=50, unique=True, verbose_name="رقم السند"
                    ),
                ),
                (
                    "payment_type",
                ...
                (
                    "date",
                    models.DateField(
                        default=django.utils.timezone.now, verbose_name="تاريخ الدفعة"
                    ),
                ),
                (
                    "notes",
                ...
                (
                    "is_posted",
                    models.BooleanField(default=False, verbose_name="تم إنشاء القيد؟"),
                ),
                (
                    "customer",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "invoice_number",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="رقم الفاتورة"
                    ),
                ),
                (
                    "status",
                ...
                (
                    "return_reason",
                    models.TextField(
                        blank=True, default="0", null=True, verbose_name="سبب المرتجع"
                    ),
                ),
                (
                ...
                (
                    "company",
                    models.ForeignKey(
                        default=invoices.models.get_default_company,
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="invoices.companysettings",
                        verbose_name="الشركة",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name_ar",
                    models.CharField(max_length=255, verbose_name="اسم المنتج بالعربي"),
                ),
                (
                    "serial_number",
                    models.CharField(
                        max_length=255, unique=True, verbose_name="الرقم التسلسلي"
                    ),
                ),
                (
                    "price",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True, default=999999999, verbose_name="الكمية المتاحة"
                    ),
                ),
                (
                    "low_stock_threshold",
                    models.PositiveIntegerField(
                        blank=True, default=10, null=True, verbose_name="حد التنبيه"
                    ),
                ),
                (
                    "inventory_account",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "larger_unit_name",
                    models.CharField(max_length=100, verbose_name="اسم الوحدة الأكبر"),
                ),
                (
                    "larger_unit_abbreviation",
                    models.CharField(max_length=20, verbose_name="التمييز"),
                ),
                (
                    "conversion_factor",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="معامل التحويل"
                    ),
                ),
                (
                    "base_unit",
